...
This project implements a complete MySQL monitoring solution using Prometheus, Grafana, and mysqld_exporter. It collects metrics from 
MySQL, scrapes them via Prometheus, and visualizes them in Grafana dashboards. The project also includes scripts to start exporters and 
