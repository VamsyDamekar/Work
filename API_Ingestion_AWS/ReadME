...
producer_script.py – script to fetch weather data and send it to Kinesis.
lambda_code.py – Lambda code to transform records and store them in S3.
main.tf – Terraform script to provision all AWS resources for the pipeline.
